...
public class SignLink implements Runnable
{
	...
	private static final FileOnDisk method3630(String string, int i, String string_5_, int i_6_) {
		...
		String[] strings = {ClientLoader.getWebClientCachePath()};
	...
	final Class241 method3638(Class<?> var_class, @SuppressWarnings("rawtypes") Class[] var_classes, String string, boolean bool) {
		if (bool != false) {
			method3635(-84);
		}
									...
									if ((i ^ 0xffffffff) == -4) {
										...
										if ((i ^ 0xffffffff) == -7) {
											...
											if (aBoolean3985) {
												...
												Class.forName("Display").getMethod("enter", new Class[] { aClass4006 == null ? aClass4006 = method3646("java.awt.Frame") : aClass4006, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE }).invoke(anObject3980, new Object[] { frame, new Integer(class241.anInt2952 >>> 16), new Integer(0xffff & class241.anInt2952), new Integer(class241.anInt2951 >> 16), new Integer(0xffff & class241.anInt2951) });
											}
										} else if (i == 7) {
											if (aBoolean3985) {
												aClass11_3997.method192((Frame) class241.anObject2954, 8);
											} else {
												Class.forName("Display").getMethod("exit", new Class[0]).invoke(anObject3980, new Object[0]);
											}
										...
										class241.anObject2956 = Class.forName("Display").getMethod("listmodes", new Class[0]).invoke(anObject3980, new Object[0]);
									} else {
		...
		if (aBoolean4005) {
			...
			try {
				if (aBoolean3985) {
					...
					anObject3980 = Class.forName("Display").newInstance();
				}
			} catch (Throwable throwable) {
				/* empty */
			}
