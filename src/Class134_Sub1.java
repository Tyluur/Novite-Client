		...
		if (cachenode_sub13 != null && cachenode_sub13 != Class368.aClass312_4549.aNode3958) {
			...
			if ((i_6_ ^ 0xffffffff) == -45) {
				...
				if (player != null) {
					...
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class355.aClass318_4396, Class218.aClass123_2566.issacKeys);
			...
			if (i_6_ == 12) {
				...
				if (class318 != null) {
					...
					if (player != null) {
						...
						Node_Sub38_Sub28.anInt10403 = 2;
						Class93_Sub2.anInt6067 = i_3_;
						OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, class318, Class218.aClass123_2566.issacKeys);
				...
				if (class318_8_ != null) {
					...
					Class93_Sub2.anInt6067 = i_3_;
					Class282.anInt3587++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(i_2_ ^ ~0x180, class318_8_, Class218.aClass123_2566.issacKeys);
				...
				if (class318_9_ != null) {
					...
					if (node_sub41 != null) {
						...
						Class163.anInt2014 = i;
						Node_Sub37.anInt7431 = 0;
						OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(i_2_ ^ ~0x180, class318_9_, Class218.aClass123_2566.issacKeys);
				...
				if (class318_10_ != null) {
					...
					Class93_Sub2.anInt6067 = i_3_;
					Class317.anInt4039++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(i_2_ ^ ~0x180, class318_10_, Class218.aClass123_2566.issacKeys);
				...
				if ((i_6_ ^ 0xffffffff) == -22) {
					...
					Node_Sub37.anInt7431 = 0;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, RuntimeException_Sub1.aClass318_4920, Class218.aClass123_2566.issacKeys);
					node_sub13.currentOutgoingPacket.writeShort128(Node_Sub53.gameSceneBaseX - -i_4_);
				...
				if ((i_6_ ^ 0xffffffff) == -18) {
					...
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(i_2_ + -387, Class102.aClass318_1314, Class218.aClass123_2566.issacKeys);
				...
				if ((i_6_ ^ 0xffffffff) == -24) {
					...
					if (node_sub41 != null) {
						...
						Class93_Sub2.anInt6067 = i_3_;
						Class163.anInt2014 = i;
						OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class269.aClass318_3470, Class218.aClass123_2566.issacKeys);
						node_sub13.currentOutgoingPacket.writeShortLE128(Class46.anInt681);
						node_sub13.currentOutgoingPacket.writeShortLE(Class92.anInt1230);
						node_sub13.currentOutgoingPacket.writeShortLE(index);
						node_sub13.currentOutgoingPacket.writeIntV2(Node_Sub15_Sub9.anInt9839);
				...
				if (i_6_ == 60) {
					...
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, EntityNode_Sub3_Sub1.aClass318_9159, Class218.aClass123_2566.issacKeys);
