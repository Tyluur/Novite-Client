	...
	static final void processClientCommand(int i, boolean bool, boolean bool_11_, String string) {
		...
		try {
			...
			if (string.equalsIgnoreCase("getcamerapos")) {
				Node_Sub7.method2422((byte) 43, "Pos: " + Class295.myPlayer.plane + "," + ((Class98.anInt5061 >> 9) + Node_Sub53.gameSceneBaseX >> 6) + "," + ((Node_Sub10.anInt7079 >> 9) - -Class320_Sub4.gameSceneBaseY >> 6) + "," + ((Class98.anInt5061 >> 9) - -Node_Sub53.gameSceneBaseX & 0x3f) + "," + ((Node_Sub10.anInt7079 >> 9) - -Class320_Sub4.gameSceneBaseY & 0x3f) + " Height: " + (Node_Sub38_Sub7.method2809(Class295.myPlayer.plane, -29754, Node_Sub10.anInt7079, Class98.anInt5061) + -Class190.anInt2331));
				Node_Sub7.method2422((byte) 43, "Look: " + Class295.myPlayer.plane + "," + (Class238.anInt2911 + Node_Sub53.gameSceneBaseX >> 6) + "," + (Class320_Sub4.gameSceneBaseY + Class10.anInt174 >> 6) + "," + (0x3f & Node_Sub53.gameSceneBaseX + Class238.anInt2911) + "," + (0x3f & Class320_Sub4.gameSceneBaseY + Class10.anInt174) + " Height: " + (Node_Sub38_Sub7.method2809(Class295.myPlayer.plane, -29754, Class10.anInt174, Class238.anInt2911) + -Class134_Sub1.anInt9015));
				return;
			}
		...
		if (Class339_Sub7.rights >= 2) {
			...
			try {
				...
				if (string.equalsIgnoreCase("getcgcoord")) {
					Node_Sub7.method2422((byte) 43, "x:" + (Class295.myPlayer.y >> 9) + " z:" + (Class295.myPlayer.x >> 9));
					return;
				}
				if (string.equalsIgnoreCase("getheight")) {
					Node_Sub7.method2422((byte) 43, "Height: " + Class320_Sub10.aPlaneArray8300[Class295.myPlayer.plane].method3251(Class295.myPlayer.x >> 9, Class295.myPlayer.y >> 9, (byte) -118));
					return;
				}
				...
				if (string.equals("nonpcs")) {
					...
					Node_Sub7.method2422((byte) 43, "nonpcs=" + Node_Sub29.showNpcs);
					return;
				}
				...
				if ((Class151.anInt1843 ^ 0xffffffff) == -12) {
					...
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class247.aClass318_3130, Class218.aClass123_2566.issacKeys);
				...
				if (string_39_ != null) {
					...
					for (int i = 0; (Node_Sub38_Sub14.anInt10242 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
						...
						if (string_42_ != null && string_42_.equals(string_39_)) {
							Class41.method436(29459, Class22.aClass22_408.method297(Class35.language) + string + Class22.aClass22_409.method297(Class35.language), 4);
							return;
						}
					...
					if (Node_Sub25_Sub3.method2671(-13472, Class295.myPlayer.aString11142).equals(string_39_)) {
						...
						OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class320_Sub3.addIgnore, class123.issacKeys);
