...
public class Class157
{
	...
	static final void method1710(int i, int i_2_, boolean bool, int i_3_, int i_4_, int i_5_) {
		...
		if (Class175.aClass261ArrayArrayArray2099 == null) {
			...
			if (aa.anInt101 == 0) {
				if (Class295.myPlayer.y < 0 || (Class295.myPlayer.y ^ 0xffffffff) <= (512 * Node_Sub54.GAME_SCENE_WDITH ^ 0xffffffff) || Class295.myPlayer.x < 0 || Class295.myPlayer.x >= Class377_Sub1.GAME_SCENE_HEIGHT * 512) {
					bool_6_ = true;
				}
			...
			if (bool_6_) {
				...
				Class110.anInt1412++;
				if (Class295.myPlayer != null && (Class295.myPlayer.y + (-(256 * Class295.myPlayer.getSize((byte) 45)) + 256) >> 9 ^ 0xffffffff) == (Class359.anInt4467 ^ 0xffffffff) && (Class295.myPlayer.x + -(256 * (Class295.myPlayer.getSize((byte) 48) + -1)) >> 9 ^ 0xffffffff) == (Node_Sub15_Sub4.anInt9798 ^ 0xffffffff)) {
				...
				if ((Class320_Sub22.anInt8415 ^ 0xffffffff) == -2) {
					...
					Node_Sub23.method2624(i_7_, (i_7_ >> 3) * Constants.ZOOM_MODIFIER + 600 << 2, i_4_, 101, Mobile_Sub4.anInt10987, i_8_, Class25.anInt444, -200 + Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, Class295.myPlayer.x, Class295.myPlayer.y));
					...
					Node_Sub23.method2624(i_9_, (i_9_ >> 3) *  Constants.ZOOM_MODIFIER  + 600 << 2, i_4_, 76, Mobile_Sub4.anInt10987, i_10_, Class25.anInt444, -200 + Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, Node_Sub19.anInt7173, Class234.anInt2792));
				...
				Class290_Sub6.aClass336_8114.method3864(Class98.anInt5061, Class190.anInt2331, Node_Sub10.anInt7079, 0x3fff & -OutgoingPacket.anInt4050, -Class170.anInt2053 & 0x3fff, 0x3fff & -Class48.anInt704);
				...
				if (!Class71.aBoolean967) {
					if (Class245.aClass119_3085 == null) {
						...
						Class245.aClass119_3085.method1216(true, i_2_, Class93.aGraphicsToolkit1241, Class170.anInt2053, i_3_, i_18_, Class48.anInt704, i_4_, i_5_, Class235.anInt5127 << 3, OutgoingPacket.anInt4050, false, (byte) -32);
					}
				} else {
				...
				Class329.method3836(0x3fff & -Class170.anInt2053, 327263118, Node_Sub10.anInt7079, -Class48.anInt704 & 0x3fff, Class190.anInt2331, -OutgoingPacket.anInt4050 & 0x3fff, Class98.anInt5061);
				...
				if (Class71.aBoolean967) {
					Class291_Sub1.method3454(0x3fff & -Class170.anInt2053, 0x3fff & -Class48.anInt704, -OutgoingPacket.anInt4050 & 0x3fff, 128);
					Class251.method3099(b, Class98.anInt5061, Node_Sub10.anInt7079, Class190.anInt2331, Class295.myPlayer.x >> 9, Class246.anIntArray3107, Class362.anIntArray4497, Class174.clientCycle, 1 + Class295.myPlayer.plane, Class259.anIntArray3296, Class213.aNode_Sub27_2512.aClass320_Sub8_7280.method3712(false) == 0, true, Class308.anInt3912, MainFile.anIntArray135, Node_Sub38_Sub15.aByteArrayArrayArray10261, Class84.anIntArray1147, Class295.myPlayer.y >> 9, 1);
				} else {
					Class151.method1671(Class174.clientCycle, Class98.anInt5061, Class190.anInt2331, Node_Sub10.anInt7079, Node_Sub38_Sub15.aByteArrayArrayArray10261, Class259.anIntArray3296, MainFile.anIntArray135, Class246.anIntArray3107, Class84.anIntArray1147, Class362.anIntArray4497, 1 + Class295.myPlayer.plane, b, Class295.myPlayer.y >> 9, Class295.myPlayer.x >> 9, (Class213.aNode_Sub27_2512.aClass320_Sub8_7280.method3712(false) ^ 0xffffffff) == -1, true, !Node_Sub15_Sub10.aBoolean9850 ? -1 : Class308.anInt3912, 0, false);
				}
				CacheNode_Sub16_Sub1.method2387((byte) -114);
				if (Class151.anInt1843 == 11) {
					Class262_Sub6.drawTileStrings((byte) 55, i_3_, 256, i_4_, 256, i_2_, i_5_);
					Class339_Sub7.method3942(i_2_, i_3_, 256, 256, i_5_, i_4_, true);
					Class127.drawHintIcons(3, 256, 256, i_3_, i_2_, i_5_, i_4_);
				...
				if (Class230.aBoolean5214) {
					Class93.aGraphicsToolkit1241.method1239(i_3_, i_4_, i_2_, (byte) 116, i_5_, -16777216);
					Class169_Sub3.method1779(Class93.aGraphicsToolkit1241, Class22.aClass22_375.method297(Class35.language), false, Class169_Sub3.aClass357_8820, StandardSprite.aClass52_8945, -16777216);
				}
