...
abstract class Animable_Sub1 extends Animable
{
	...
	static final void method824(byte b) {
		...
		anInt9104++;
		OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class239.aClass318_2929, Class218.aClass123_2566.issacKeys);
	...
	final boolean method815(byte b, GraphicsToolkit graphicstoolkit) {
		...
		return Class313.method3649(true, x >> Class36.anInt549, aByte5931, y >> Class36.anInt549);
	}
	...
	final boolean method806(int i) {
		...
		return Class139.aBooleanArrayArray1730[Node_Sub9_Sub1.anInt9656 + ((y >> Class36.anInt549) - Class216.anInt2551)][Node_Sub9_Sub1.anInt9656 + (-EntityNode_Sub7.anInt6013 + (x >> Class36.anInt549))];
	}
	...
	final int method819(Node_Sub29[] node_sub29s, int i) {
		...
		return this.method808(i ^ ~0x59ee, node_sub29s, x >> Class36.anInt549, y >> Class36.anInt549);
	}
}
