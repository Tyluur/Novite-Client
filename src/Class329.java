...
public class Class329
{
	...
	static final void method3834(int i, int i_0_, int i_1_, aa var_aa, GraphicsToolkit graphicstoolkit, int i_2_, int i_3_, int i_4_, IComponentDefinitions widget) {
		anInt4120++;
