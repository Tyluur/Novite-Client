...
public class Class64 implements Interface6
{
	...
	static OutgoingPacket aClass318_5048;
	...
	static final void method712(int i) {
		if (i == 25053) {
			Class365_Sub1.anInt8769 = Class304.anInt3835 = Class258.anInt5291 = OutgoingPacketBuffer.anInt7107 = 0;
			anInt5047++;
		}
	}
	...
	static {
		...
		aClass318_5048 = new OutgoingPacket(91, 8);
	}
}
