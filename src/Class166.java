...
public class Class166 implements Interface7
{
	...
	static final void method1747(byte b, IComponentDefinitions widget) {
		...
		if (Class87.removeWalkHere) {
			...
			OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class270.aClass318_3474, Class218.aClass123_2566.issacKeys);
			node_sub13.currentOutgoingPacket.writeIntV1(widget.ihash);
			node_sub13.currentOutgoingPacket.writeShort128(Class92.anInt1230);
