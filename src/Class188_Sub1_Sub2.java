...
public class Class188_Sub1_Sub2 extends Class188_Sub1
{
	...
	static final boolean method1899(int i, byte b, String string) {
		...
		if (Class240.aSignLink2946.aBoolean4005) {
			...
			if (Node_Sub38_Sub1.aClass329_10086 != Class240.aClass329_2943) {
				Class181.aClass197_2155.firstPort = ClientLoader.PORT_ID;//40000 + Class181.aClass197_2155.id;
		...
		String string_6_ = "http://" + string.replace("runescape", Constants.NAME) + string_4_ + "/l=" + Class35.language + "/a=" + Class170.anInt2056 + string_5_ + "/j" + (Animable_Sub2_Sub1.aBoolean10628 ? "1" : "0") + ",o" + (Node_Sub38_Sub21.aBoolean10320 ? "1" : "0") + ",a2";
		try {
	...
	static final void method1901(String string, int i, int i_10_) {
		...
		OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class229.aClass318_2731, class123.issacKeys);
