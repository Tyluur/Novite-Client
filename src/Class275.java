...
public class Class275 implements Interface17
{
	...
	final void method3328(int i, int i_0_, int i_1_) {
		...
		if (node_sub44 != null) {
			...
			aHashTable5420.put((long) i_0_, node_sub44, -124);
		}
	}
	...
	final void method3333(int i, int i_44_, int i_45_) {
		...
		i_49_ <<= i_47_;
		sendConfig((byte) -97, i_46_, i << i_47_ & i_49_ | anIntArray5421[i_46_] & (i_49_ ^ 0xffffffff));
	}
	...
	final void sendConfig(byte b, int i, int i_52_) {
		...
		if (node_sub44 == null) {
			...
			aHashTable5420.put((long) i, node_sub44, -126);
