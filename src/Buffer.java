...
/*		anInt7001++;
		...
		readBytes(bs, 0, i_50_);
		BigInteger biginteger_51_ = new BigInteger(bs);
		BigInteger biginteger_52_ = biginteger_51_.modPow(Constants.RSA_EXPONENT, Constants.RSA_MODULUS);
		byte[] bs_53_ = biginteger_52_.toByteArray();
		bs_53_ = bs;
		offset = 0;
		writeShort(bs_53_.length);
		writeBytes(bs_53_.length, bs_53_, 0);*/
	}
