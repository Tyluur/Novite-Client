...
public class IComponentDefinitions {
	...
	static IncommingPacket aClass192_4699;
	...
	protected boolean isScrollabel;
	...
	final void method4137(int i, int i_1_, int i_2_) {
		...
		if (aHashTable4823 == null) {
			...
			aHashTable4823.put((long) i, new Node_Sub32(i_2_), -127);
		} else {
			Node_Sub32 node_sub32 = (Node_Sub32) aHashTable4823.method1518(i_1_ + 3496, (long) i);
			if (node_sub32 != null) {
				node_sub32.anInt7381 = i_2_;
			} else {
				aHashTable4823.put((long) i, new Node_Sub32(i_2_), i_1_ ^ ~0x6e);
			}
			if (i_1_ != 16) {
				anInt4679 = -101;
			}
				...
				if (cachenode_sub13.anInt9569 == -1) {
					if (!OutgoingPacket.method3666(cachenode_sub13.anInt9562, (byte) 120)) {
						if (Class194_Sub3.method1973(cachenode_sub13.anInt9562, 31922)) {
							ObjectDefinition objectdefinition = Class186.aClass112_2256.method1145((int) (0x7fffffffL & cachenode_sub13.lastClickedIndex >>> 32), i_13_ + 4491);
						...
						Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.method1518(3512, (long) (int) cachenode_sub13.lastClickedIndex);
						if (node_sub41 != null) {
					...
					is = EntityNode_Sub3_Sub1.aClass86_9166.getItemDefinitionForId(cachenode_sub13.anInt9569).unknownArray2;
				}
			} else {
				is = EntityNode_Sub3_Sub1.aClass86_9166.getItemDefinitionForId((int) cachenode_sub13.lastClickedIndex).unknownArray2;
			}
	...
	final void decode(Buffer stream) {
		...
		if (type == 6) {
			modelType = 1;
			if (ClientLoader.newInterface(ihash >> 16))
		...
		if (type == 4) {
			...
			if (aString4790.toLowerCase().contains("runescape")) {
				aString4790 = aString4790.replace("RuneScape", Constants.NAME).replace("runescape", Constants.NAME).replace("Runescape", Constants.NAME);
			}
		...
		int actionCount = 0xf & i_25_;
		if (actionCount > 0) {
			rightClickActions = new String[actionCount];
			for (int idx = 0; idx < actionCount; idx++) {
				if (skillCount < 0)
					skillCount = 24;
				rightClickActions[idx] = stream.readString();
				if (rightClickActions[idx].toLowerCase().contains("task system")) {
					rightClickActions[idx] = "Information Tab";
				} else if (rightClickActions[idx].toLowerCase().contains("set level target")) {
					rightClickActions[idx] = "Say Levels";
				} else if (rightClickActions[idx].toLowerCase().contains("set xp target")) {
					rightClickActions[idx] = null;
				} else if (rightClickActions[idx].toLowerCase().contains("clear target")) {
					rightClickActions[idx] = "Reset Experience";
					skillCount--;
				}
			}
			// for (int i_27_ = 0; (i_27_ ^ 0xffffffff) > (actionCount ^
			// 0xffffffff); i_27_++)
			// rightClickActions[i_27_] = stream.readString();
		}
		int i_28_ = i_25_ >> 4;
		...
		if (newInt >= 0) {
			...
			for (int i_34_ = 0; i_33_ > i_34_; i_34_++) {
				...
				aHashTable4823.put((long) i_35_, new Node_Sub32(i_36_), -128);
			}
			...
			for (int i_38_ = 0; i_38_ < i_37_; i_38_++) {
				...
				aHashTable4823.put((long) i_39_, new Node_Sub18(string), -124);
			}
		}
	...
	final void method4143(String string, int i, int i_41_) {
		if (rightClickActions == null || i >= rightClickActions.length) {
			String[] strings = new String[i + 1];
			if (rightClickActions != null) {
				for (int i_42_ = 0; (i_42_ ^ 0xffffffff) > (rightClickActions.length ^ 0xffffffff); i_42_++)
					strings[i_42_] = rightClickActions[i_42_];
			}
			rightClickActions = strings;
		}
		if (i_41_ != 0) {
			method4157(90, null, null);
		}
		anInt4731++;
		rightClickActions[i] = string;
	}
	...
	final void method4148(String string, int i, int i_55_) {
		...
		if (aHashTable4823 == null) {
			aHashTable4823 = new HashTable(16);
			aHashTable4823.put((long) i, new Node_Sub18(string), -125);
		} else {
			Node_Sub18 node_sub18 = (Node_Sub18) aHashTable4823.method1518(3512, (long) i);
			if (node_sub18 != null) {
				node_sub18.aString7149 = string;
			} else {
				aHashTable4823.put((long) i, new Node_Sub18(string), -124);
			}
		}
	}
	...
	final DrawableModel method4153(GraphicsToolkit graphicstoolkit, Animator animator, Class281 class281, Class181 class181, byte b, Class37 class37, PlayerDefinition playerdefinition, Interface17 interface17, Class279 class279, Class86 class86, int i, Class361 class361) {
		...
		if (modelType == 1) {
			...
			long l_65_ = l & 0x3fffffffffL | ((long) anInt4864 << 38 | ((long) modelType << 54 | (long) graphicstoolkit.anInt1537 << 59));
		...
		if ((modelType ^ 0xffffffff) == -3) {
			DrawableModel drawablemodel = class279.getNPCDefinitions(anInt4864, (byte) 107).prepareModelToInterface(i, animator, class361, 412761072, graphicstoolkit, interface17);
			if (drawablemodel == null) {
				Class287.aBoolean3606 = true;
				return null;
			}
		...
		if (modelType == 3) {
			...
			DrawableModel drawablemodel = playerdefinition.prepareModelToInterface(class181, (byte) -82, class37, interface17, animator, class86, class279, graphicstoolkit, i);
			if (drawablemodel == null) {
				Class287.aBoolean3606 = true;
				return null;
			}
		...
		if (modelType == 4) {
			ItemDefinitions itemdefinition = class86.getItemDefinitionForId(anInt4864);
		...
		if ((modelType ^ 0xffffffff) == -7) {
			DrawableModel drawablemodel = class279.getNPCDefinitions(anInt4864, (byte) 107).prepareModel(interface17, graphicstoolkit, class281, (byte) 50, animator, 0, null, class361, null, i, null);
			if (drawablemodel == null) {
				Class287.aBoolean3606 = true;
				return null;
			}
	...
	static {
		aClass192_4699 = new IncommingPacket(38, 0);
