...
public abstract class GameStub extends Applet implements Runnable, FocusListener, WindowListener {
	...
	final void method87(int i, byte b, int i_0_, int i_1_, int i_2_, boolean bool, String string, int i_3_) {
		...
		try {
			...
			Class36.anInt542 = Class360.screenWidth = i_3_;
			Class131.anInt5447 = 0;
			Class270_Sub1.anInt8033 = 0;
			CacheNode_Sub3.anInt9441 = Class205.screenHeight = i_2_;
			Class82.aGameStub1123 = this;
			Node_Sub29.aFrame7344 = new Frame();
			Node_Sub29.aFrame7344.setTitle(Constants.NAME);
	...
	final void method92(int i, int i_7_, int i_8_, int i_9_, String string, int i_10_, int i_11_) {
		...
		try {
			if (Class82.aGameStub1123 != null) {
				...
				Class270_Sub1.anInt8033 = 0;
				CacheNode_Sub3.anInt9441 = Class205.screenHeight = i_11_;
				Class131.anInt5447 = 0;
				Class82.aGameStub1123 = this;
	...
	final boolean method95(byte b) {
		return true;
		/*
		 * if (b != -45) { return true; } anInt36++; String string =
		 * getDocumentBase().getHost().toLowerCase(); if
		 * (string.endsWith(Loader.IP)) { return true; } if
		 * (string.equals("jagex.com") || string.endsWith(".jagex.com")) {
		 * return true; } if (string.equals("runescape.com") ||
		 * string.endsWith(".runescape.com")) { return true; } if
		 * (string.equals("stellardawn.com") ||
		 * string.endsWith(".stellardawn.com")) { return true; } if
		 * (string.endsWith("127.0.0.1")) { return true; } for (/*
		 *//*
			 * ; (string.length() ^ 0xffffffff) < -1 && (string.charAt(-1 +
			 * string.length()) ^ 0xffffffff) <= -49; string =
			 * string.substring(0, string.length() - 1)) { if
			 * ((string.charAt(string.length() - 1) ^ 0xffffffff) < -58) {
			 * break; } } if (string.endsWith("192.168.1.")) { return true; }
			 * method90("invalidhost", (byte) 39); return false;
			 */
	}
