...
{
	static OutgoingPacket aClass318_3103;
	...
	static final void method3072(byte b) {
		...
		Node_Sub38_Sub22.aShort10325 = OutgoingPacket.aShort4053;
		if (b <= 5) {
			method3071((byte) 79);
		}
		anInt3105++;
		...
		if (Class270_Sub1.anInt8034 != 0 && Class259.anInt3254 != 0) {
			OutgoingPacket.aShort4053 = Class18.aShort310 = (short) 334;
	...
	static {
		...
		aClass318_3103 = new OutgoingPacket(60, -1);
	}
}
