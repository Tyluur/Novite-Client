...
public class r_Sub1 extends r
{
	...
	static final void method2364(int i, int i_1_, int i_2_, String string, int i_3_) {
		anInt11043++;
		IComponentDefinitions widget = Node_Sub3.method2169(-101, i_2_, i_1_);
		if (widget != null) {
			...
			if ((Class151.anInt1843 ^ 0xffffffff) == -12 && Client.method113(widget).method2748((byte) -98, -1 + i_3_)) {
				if (i_3_ == 1) {
					...
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Node_Sub42.aClass318_7526, Class218.aClass123_2566.issacKeys);
				...
				if ((i_3_ ^ 0xffffffff) == -3) {
					...
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class170.aClass318_2051, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if (i_3_ == 3) {
					Class279.anInt3550++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class262_Sub9.aClass318_7765, Class218.aClass123_2566.issacKeys);
				...
				if ((i_3_ ^ 0xffffffff) == -5) {
					Class385.anInt4912++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class377.aClass318_4663, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if (i_3_ == 5) {
					Class270_Sub1.anInt8032++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class368.aClass318_4544, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -126, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if ((i_3_ ^ 0xffffffff) == -7) {
					Node_Sub27.anInt7286++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class64.aClass318_5048, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, 97, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if (i_3_ == 7) {
					GraphicsBuffer.anInt7144++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class189.aClass318_2295, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(126, node_sub13);
				}
				if (i_3_ == 8) {
					Class235_Sub1.anInt8977++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class371.aClass318_4586, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -127, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
				if ((i_3_ ^ 0xffffffff) == -10) {
					Class300.anInt3767++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Node_Sub30.aClass318_7360, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -128, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(126, node_sub13);
				}
				if (i_3_ == 10) {
					Class161.anInt2002++;
					OutgoingPacketBuffer node_sub13 = PacketParser.createOutgoingPacket(-386, Class379.aClass318_4869, Class218.aClass123_2566.issacKeys);
					Animable_Sub4_Sub1.method927(i_1_, widget.anInt4718, -128, node_sub13, i_2_);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
				}
			}
