...
public class Class306
{
	static final GraphicsToolkit method3566(Index class302, int i, int i_0_, d var_d, java.awt.Canvas canvas) {
		...
		try {
			...
			Method method = var_class.getDeclaredMethod("createToolkit", new Class[] { Class.forName("java.awt.Canvas"), Class.forName("d"), Class.forName("Index"), Class.forName("java.lang.Integer") });
