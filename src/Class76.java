...
public class Class76
{
				...
				if (i_3_ == -1) {
					...
					if ((i_3_ & ~0x3fffffff) != -1073741824) {
						if ((0x8000 & i_3_ ^ 0xffffffff) != -1) {
							...
							i_7_ = -player.x + actor.x;
							i_6_ = actor.y + -player.y;
						} else {
						...
						int i_10_ = i_9_ >> 14;
						i_6_ = actor.y - (256 + 512 * (-Node_Sub53.gameSceneBaseX + i_10_));
						int i_11_ = i_9_ & 0x3fff;
						i_7_ = -256 + (-(512 * (i_11_ - Class320_Sub4.gameSceneBaseY)) + actor.x);
					}
	...
	static final IComponentDefinitions method771(byte b, int i) {
		if (b != 107) {
