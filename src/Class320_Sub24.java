					...
					if ((Class174.clientCycle ^ 0xffffffff) <= (mobile_sub1.anInt10958 ^ 0xffffffff)) {
						...
						if ((mobile_sub1.anInt10942 ^ 0xffffffff) < -1) {
							if ((aa.anInt101 ^ 0xffffffff) == -4) {
								...
								if (actor != null && (actor.y ^ 0xffffffff) <= -1 && actor.y < Node_Sub54.GAME_SCENE_WDITH * 512 && actor.x >= 0 && (actor.x ^ 0xffffffff) > (512 * Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff)) {
									mobile_sub1.method895(Node_Sub38_Sub7.method2809(mobile_sub1.plane, -29754, actor.x, actor.y) + -mobile_sub1.anInt10938, false, Class174.clientCycle, actor.x, actor.y);
								}
							} else {
								Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.method1518(3512, (long) (-1 + mobile_sub1.anInt10942));
								if (node_sub41 != null) {
									Npc npc = node_sub41.aNpc7518;
									if (npc.y >= 0 && npc.y < Node_Sub54.GAME_SCENE_WDITH * 512 && npc.x >= 0 && (npc.x ^ 0xffffffff) > (512 * Class377_Sub1.GAME_SCENE_HEIGHT ^ 0xffffffff)) {
										mobile_sub1.method895(Node_Sub38_Sub7.method2809(mobile_sub1.plane, -29754, npc.x, npc.y) - mobile_sub1.anInt10938, false, Class174.clientCycle, npc.x, npc.y);
									}
								}
							}
						}
						if (mobile_sub1.anInt10942 < 0) {
							...
							if (player != null && player.y >= 0 && Node_Sub54.GAME_SCENE_WDITH * 512 > player.y && player.x >= 0 && 512 * Class377_Sub1.GAME_SCENE_HEIGHT > player.x) {
								mobile_sub1.method895(Node_Sub38_Sub7.method2809(mobile_sub1.plane, -29754, player.x, player.y) - mobile_sub1.anInt10938, false, Class174.clientCycle, player.x, player.y);
							}
						}
