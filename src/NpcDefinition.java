...
public class NpcDefinition {
	...
	final boolean method2998(byte b) {
		...
		for (/**/; (anIntArray2827.length ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
			if ((anIntArray2827[i] ^ 0xffffffff) != 0) {
				NpcDefinition npcdefinition_0_ = aClass279_2861.getNPCDefinitions(anIntArray2827[i], (byte) 107);
	...
	final NpcDefinition method2999(int i, Interface17 interface17) {
		...
		return aClass279_2861.getNPCDefinitions(anIntArray2827[i_1_], (byte) 107);
	}
	...
	private final void method3004(int opcode, Buffer buffer, byte b) {
		...
		if ((opcode ^ 0xffffffff) == -2) {
																				...
																				if ((opcode ^ 0xffffffff) == -138) {
																					...
																					if ((opcode ^ 0xffffffff) == -140) {
																						...
																						if ((opcode ^ 0xffffffff) == -143) {
																							...
																							rightClickActions[-150 + opcode] = buffer.readString();
																							if (!aClass279_2861.aBoolean3556) {
																								rightClickActions[opcode + -150] = null;
																							}
																									...
																									if (opcode == 163) {
																										...
																										if ((opcode ^ 0xffffffff) == -166) {
																											...
																											for (int i_19_ = 0; (i_17_ ^ 0xffffffff) < (i_19_ ^ 0xffffffff); i_19_++) {
																												...
																												aHashTable2813.put((long) i_20_, node, -127);
																											}
																										} else {
			...
			rightClickActions[-30 + opcode] = buffer.readString();
		}
		if (b >= -66) {
			anInt2858 = 38;
		}
	...
	final DrawableModel prepareModelToInterface(int i, Animator animator, Class361 class361, int i_28_, GraphicsToolkit graphicstoolkit, Interface17 interface17) {
		anInt2846++;
		if (anIntArray2827 != null) {
			...
			return npcdefinition_29_.prepareModelToInterface(i, animator, class361, 412761072, graphicstoolkit, interface17);
		}
	...
	final DrawableModel prepareModel(Interface17 interface17, GraphicsToolkit graphicstoolkit, Class281 class281, byte b, Animator animator, int i, int[] is, Class361 class361, Animator animator_37_, int i_38_, Animator[] animators) {
		anInt2869++;
		if (anIntArray2827 != null) {
			...
			return npcdefinition_39_.prepareModel(interface17, graphicstoolkit, class281, (byte) -93, animator, i, is, class361, animator_37_, i_38_, animators);
		}
		int i_40_ = i_38_;
