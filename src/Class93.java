...
abstract class Class93
{
	...
	static final Node_Sub2 method1047(int i, int id, int i_10_, int i_11_, boolean isWindowPane) {
		anInt1239++;
		Node_Sub2 node_sub2 = new Node_Sub2();
		node_sub2.interfaceId = id;
		node_sub2.cliped = i;
		Class289.aHashTable3630.put((long) i_10_, node_sub2, -126);
		Node_Sub11.method2543(id, i_11_);
		IComponentDefinitions widget = Class76.method771((byte) 107, i_10_);
		if (widget != null) {
		...
		if (!isWindowPane && (Class320_Sub15.WINDOWS_PANE_ID ^ 0xffffffff) != 0) {
