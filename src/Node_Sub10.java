	...
	static final void method2537(int i, boolean bool) {
		...
		if (bool == false) {
			if ((i_0_ ^ 0xffffffff) <= -101) {
				...
				Node_Sub23.method2624(i_1_, (i_1_ >> 3) * Constants.ZOOM_MODIFIER + 600 << 2, i, 127, Mobile_Sub4.anInt10987, i_2_, Class25.anInt444, Node_Sub38_Sub7.method2809(CacheNode_Sub20_Sub1.myPlayerPlane, -29754, Class295.myPlayer.x, Class295.myPlayer.y) - 200);
