	...
	static final void method3309(Animable animable, Node_Sub29[] node_sub29s) {
		...
		if (Class368.aPlaneArray4548 == Class320_Sub10.aPlaneArray8300) {
			...
			if (animable instanceof Mobile) {
				...
				i = animable.y >> Class36.anInt549;
				i_1_ = animable.x >> Class36.anInt549;
			}
			CacheNode_Sub18.aGraphicsToolkit9607.EA(Node_Sub38_Sub37.aPlaneArray10466[0].method3260(animable.x, -123, animable.y), Class320_Sub2.method3684(i, i_1_), Class184.method1844(i, i_1_), Class117_Sub2.method1172(i, i_1_));
		}
