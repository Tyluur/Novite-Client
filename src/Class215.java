...
public class Class215
{
	...
	static byte[] GLOBAL_PLAYER_UPDATE_FLAG = null;//new byte[2048];
	...
	static final boolean method2062(int i, int i_0_, int i_1_) {
		...
		if (!((0x70000 & i_1_ ^ 0xffffffff) != -1 | Node_Sub38_Sub4.method2797(0, i_0_, i_1_)) && !OutgoingPacket.method3669(i_1_, (byte) 123, i_0_)) {
			return false;
		}
		return true;
	}
