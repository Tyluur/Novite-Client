				...
				if (i_2_ > 0) {
					...
					if (i_2_ <= aBuffer3396.offset) {
						if (aCacheNode_Sub16_Sub1_3397 == null) {
							...
							aCacheNode_Sub16_Sub1_3397.aBuffer11072 = new Buffer(i_11_ + size - -aCacheNode_Sub16_Sub1_3397.aByte11069);
